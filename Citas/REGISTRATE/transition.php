...
<body>
  <div id="popup">
    <img src="Logo1.png" alt="Logo" width="200" height="200"> <!-- Reemplaza 'Logo1.png' con la ruta de tu imagen -->
  </div>
  ...
  <script>
    window.addEventListener('load', function() {
      ...
      setTimeout(function() {
        window.location.href = "iniciosecion.php"; // Reemplaza 'pagina_principal.html' por la URL de tu página principal
